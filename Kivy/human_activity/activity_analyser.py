...
class Senser():
    _labels_to_be_used = ('Sitting', 'Walking', 'Jogging')
...
class ActivityAnalyser():
    def __init__(self) -> None:
        self._load_analyser()
        self._labels = { 0:'Sitting', 1:'Walking', 2:'Jogging' }

    def _load_analyser(self):
        try:
            self._analyser             = tf.lite.Interpreter(model_path="final_human_activity.tflite")
...
if __name__ == "__main__":
    ...
    print( analyser.analyse(Senser.data_sequence(90), func ) )
    input("_")
