...
class Ui_MainWindow(QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.lbl_ports = QLabel(self.centralwidget)
        self.lbl_ports.setObjectName(u"lbl_ports")
        self.lbl_ports.setGeometry(QRect(230, 320, 141, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_ports.setText(QCoreApplication.translate("MainWindow", u"0", None))
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Ports Available:", None))
    # retranslateUi

    def set_info(self, info):
        client_count, port_count = info.split("_")
        self.set_connected_clients(client_count)
        self.set_available_ports(port_count)
    ...
    def set_available_ports(self, count):
        self.lbl_ports.setText(f"{count}") 
